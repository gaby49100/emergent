...
def generate_signed_url(base_url: str, file_path: str, secret_key: str, expiry_hours: int = 0) -> tuple:
    """Génère une URL signée pour nginx secure_link (sans expiration pour les tests)"""
    import hashlib
    import base64
